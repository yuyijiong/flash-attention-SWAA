...
if USE_TRITON_ROCM:
    ...
    import flash_attn_2_cuda_vllm as flash_attn_gpu
...
@_torch_custom_op_wrapper("flash_attn_vllm::_flash_attn_forward", mutates_args=(), device_types="cuda")
...
@_torch_register_fake_wrapper("flash_attn_vllm::_flash_attn_forward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_forward = torch.ops.flash_attn_vllm._flash_attn_forward
else:
    _wrapped_flash_attn_forward = _flash_attn_forward

@_torch_custom_op_wrapper("flash_attn_vllm::varlen_fwd", mutates_args=(), device_types="cuda")
def _varlen_fwd(
        q: torch.Tensor,
        k: torch.Tensor,
        v: torch.Tensor,
...
@_torch_custom_op_wrapper("flash_attn_vllm::_flash_attn_varlen_forward", mutates_args=(), device_types="cuda")
...
@_torch_register_fake_wrapper("flash_attn_vllm::_flash_attn_varlen_forward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_varlen_forward = torch.ops.flash_attn_vllm._flash_attn_varlen_forward
else:
    _wrapped_flash_attn_varlen_forward = _flash_attn_varlen_forward


@_torch_custom_op_wrapper("flash_attn_vllm::_flash_attn_backward", mutates_args=("dq", "dk", "dv"), device_types="cuda")
...
@_torch_register_fake_wrapper("flash_attn_vllm::_flash_attn_backward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_backward = torch.ops.flash_attn_vllm._flash_attn_backward
else:
    _wrapped_flash_attn_backward = _flash_attn_backward


@_torch_custom_op_wrapper("flash_attn_vllm::_flash_attn_varlen_backward", mutates_args=("dq", "dk", "dv"), device_types="cuda")
...
@_torch_register_fake_wrapper("flash_attn_vllm::_flash_attn_varlen_backward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_varlen_backward = torch.ops.flash_attn_vllm._flash_attn_varlen_backward
else:
